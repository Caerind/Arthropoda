...
void ParticleComponent::setParticleLifetime(Distribution<Time> lifetime) //-V813
{
	mParticleLifetime = lifetime;
}

void ParticleComponent::setParticlePosition(Distribution<Vector2> position) //-V813
{
	mParticlePosition = position;
}

void ParticleComponent::setParticleVelocity(Distribution<Vector2> velocity) //-V813
{
	mParticleVelocity = velocity;
}

void ParticleComponent::setParticleRotation(Distribution<F32> rotation) //-V813
{
	mParticleRotation = rotation;
}

void ParticleComponent::setParticleRotationSpeed(Distribution<F32> rotationSpeed) //-V813
{
	mParticleRotationSpeed = rotationSpeed;
}

void ParticleComponent::setParticleScale(Distribution<Vector2> scale) //-V813
{
	mParticleScale = scale;
}

void ParticleComponent::setParticleColor(Distribution<Color> color) //-V813
{
	mParticleColor = color;
}

void ParticleComponent::setParticleTextureIndex(Distribution<U32> textureIndex) //-V813
{
