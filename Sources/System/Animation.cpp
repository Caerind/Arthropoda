...
Animation::Frame::Frame(ResourceId texture, const sf::IntRect& rect, Time duration)
	: texture(texture)
	, rect(rect)
	, duration(duration)
{
...
void Animation::addFrame(ResourceId texture, const sf::IntRect& rect, Time duration)
{
