...
#ifndef OE_SIGNAL_HPP
#define OE_SIGNAL_HPP
...
#define OeDetailSignal(Keyword, SignalName, ...) using SignalName ## Type = oe::Signal<__VA_ARGS__>; Keyword SignalName ## Type SignalName

#define OeSignal(SignalName, ...) OeDetailSignal(mutable, SignalName, __VA_ARGS__)
