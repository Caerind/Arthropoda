...
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Images"))
        {
            ...
            float tex_w = (float)ImGui::GetIO().Fonts->TexWidth; //-V807
...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    ...
    if (type == 5) ImGui::SetNextWindowSizeConstraints(ImVec2(0, 0),     ImVec2(FLT_MAX, FLT_MAX), CustomConstraints::Step, (void*)100);// Fixed Step //-V566
...
struct ExampleAppConsole
{
    ...
    static char* Strdup(const char *str)                             { size_t len = strlen(str) + 1; void* buff = malloc(len); return (char*)memcpy(buff, (const void*)str, len); } //-V575
